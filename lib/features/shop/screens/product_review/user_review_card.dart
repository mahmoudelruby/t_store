  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Row(
              children: [
                const CircleAvatar(
                  backgroundImage: AssetImage(TImages.userProfileImage),
                ),
                const SizedBox(
        ...
        const ReadMoreText(
          'The user interface of the app is quite instuitive ,i was able to navigate and make purcheases seamlessly. great job!',
          trimLines: 2,
